...
<ParamField path="--scan-mode, -m" type="string" default="quick">
  Scan depth: `quick` (default, cheapest), `standard`, or `deep`.
</ParamField>
...
<ParamField path="--reasoning-effort" type="string">
  ...
  file for this run. Defaults to the configured value (`low`).
</ParamField>
...
<ParamField path="--max-turns" type="integer" default="250">
